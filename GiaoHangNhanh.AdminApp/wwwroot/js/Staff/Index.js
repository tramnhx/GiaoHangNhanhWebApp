...
var Staff = function () {
    ...
    let initialDatatable = function () {
        ...
        datatableOption.columns = [
            ...
            {
                "data": "id_Image_FullName_Email", "name": "id_Image_FullName_Email", "autoWidth": true, "title": "Người sử dụng",
            ...
            {
                "data": "maNhanVien", "name": "maNhanVien", "autoWidth": true, "title": "Mã nhân viên", "render": function (data, type, full, meta) {
                    return '<span class="text-muted">' + data + '</span>';
                }
            },
            {
