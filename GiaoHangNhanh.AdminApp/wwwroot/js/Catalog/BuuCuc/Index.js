...
var BuuCuc = function () {
                ...
                validator.validate().then(function (e) {
                    "Valid" == e ?
                        (
                            ...
                            App.sendDataToURL("/BuuCuc/Save", data, "POST")
                                .then(function (res) {
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/buucuc/DataTableGetList";
        ...
        datatableOption.columns = [
            ...
            { "data": "code", "name": "code", "autoWidth": true, "title": "Mã bưu cục" },
            { "data": "name", "name": "name", "autoWidth": true, "title": "Tên bưu cục" },
        ...
        $('#dtTable tbody').on('click', 'a.edit', function (e) {
            ...
            modal_header_text.text("Cập nhật bưu cục");
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/buucuc/DeleteByIds", dtTable, null)
            .then(function () {
                dtTable.draw();
                App.showHideButtonDelete(false);
            });
