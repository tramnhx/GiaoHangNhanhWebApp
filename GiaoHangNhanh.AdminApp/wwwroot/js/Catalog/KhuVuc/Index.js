...
var KhuVuc = function () {
    ...
    let validator = FormValidation.formValidation(modal_form[0], {
        fields: {
            ...
            kt_modal_edit_form_name: { validators: { notEmpty: { message: "vui lòng nhập tên khu vực" } } },
            kt_modal_edit_form_TinhId: { validators: { notEmpty: { message: "vui lòng nhập tỉnh" } } },
            kt_modal_edit_form_HuyenId: { validators: { notEmpty: { message: "vui lòng nhập huyện" } } }
        },
        plugins: {
                ...
                validator.validate().then(function (e) {
                    "Valid" == e ?
                        (
                            ...
                            App.sendDataToURL("/KhuVuc/Save", data, "POST")
                                .then(function (res) {
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/KhuVuc/DataTableGetList";
        ...
        datatableOption.columns = [
            ...
            {
                "data": "tinh", "name": "tinh", "autoWidth": true, "title": "Tỉnh", "render": function (data, type, full, meta) {
                    return '<span class="text-muted">' + data.name + '</span>';
                },
            },
            {
                "data": "huyen", "name": "huyen", "autoWidth": true, "title": "Huyện", "render": function (data, type, full, meta) {
                    return '<span class="text-muted">' + data.name + '</span>';
                }
            },
            {
...
<path d="M14,4.5 L14,4 C14,3.44771525 13.5522847,3 13,3 L11,3 C10.4477153,3 10,3.44771525 10,4 L10,4.5 L5.5,4.5 C5.22385763,4.5 5,4.72385763 5,5 L5,5.5 C5,5.77614237 5.22385763,6 5.5,6 L18.5,6 C18.7761424,6 19,5.77614237 19,5.5 L19,5 C19,4.72385763 18.7761424,4.5 18.5,4.5 L14,4.5 Z" fill="#000000" opacity="0.3"></path>\
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/KhuVuc/DeleteByIds", dtTable, null)
            .then(function () {
                dtTable.draw();
                App.showHideButtonDelete(false);
            });
