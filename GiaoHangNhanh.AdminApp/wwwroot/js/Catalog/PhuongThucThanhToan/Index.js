...
var PhuongThucThanhToan = function () {
    let dtTable = null;
                ...
                validator.validate().then(function (e) {
                    "Valid" == e ?
                        (
                            ...
                            App.sendDataToURL("/phuongthucthanhtoan/Save", data, "POST")
                                .then(function (res) {
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/phuongthucthanhtoan/DataTableGetList";
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/phuongthucthanhtoan/DeleteByIds", dtTable, null)
            .then(function () {
                dtTable.draw();
                App.showHideButtonDelete(false);
            });
