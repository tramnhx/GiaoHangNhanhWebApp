...
var DongBaoHang = function () {
    ...
    let initialComponents = () => {
        ...
        $('[name="btnCreate"]').click(function (e) {
            ...
            window.location.href = "/DongBaoHang/Edit";
        });
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/DongBaoHang/DataTableGetList";
        ...
        datatableOption.columns = [
            ...
            { "data": "code", "name": "code", "autoWidth": true, "title": "Mã seal bao" },
            { "data": "isDongBao", "name": "isDongBao", "autoWidth": true, "title": "Tình trạng bao" },
            { "data": "createdDate", "name": "createdDate", "autoWidth": true, "title": "Ngày đóng bao" },
            { "data": "moBaoDate", "name": "moBaoDate", "autoWidth": true, "title": "Ngày mở bao" },
            {
        ...
        $('#dtTable tbody').on('click', 'a.edit', function (e) {
            ...
            if (selectedDataRow != null) {
                window.location.href = "/DongBaoHang/Edit?id=" + selectedDataRow.id;
            }
        });
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/DongBaoHang/DeleteBaoHangByIds", dtTable, null)
            .then(function () {
                dtTable.draw();
                App.showHideButtonDelete(false);
            });
