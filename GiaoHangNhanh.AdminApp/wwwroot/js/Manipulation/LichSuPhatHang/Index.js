...
var LichSuPhatHang = function () {
    ...
    let validator = FormValidation.formValidation(modal_form[0], {
        fields: {
            ...
            kt_modal_edit_form_nhanVienId: { validators: { notEmpty: { message: "vui lòng chọn nhân viên" } } },
        },
        plugins: {
    ...
    let initialComponents = () => {
        ...
        $('[name="btnCreate"]').click(function (e) {
            ...
            editingDataRow = null;
            modal_header_text.text("Thêm phát hàng");
                ...
                validator.validate().then(function (e) {
                    "Valid" == e ?
                        (
                            ...
                            App.sendDataToURL("/LichSuPhatHang/Save", data, "POST")
                                .then(function (res) {
        ...
        // modal add
        App.initSelect2Base($('[name="kt_modal_edit_form_nhanVienId"]'), '/NhanVien/Filter', { selectedFields: ["id", "fullName"] });
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/LichSuPhatHang/DataTableGetList";
        ...
        datatableOption.columns = [
            ...
            {
                "data": "nhanVien", "name": "nhanVien", "autoWidth": true, "title": "Nhân viên", "render": function (data, type, full, meta) {
        ...
        $('#dtTable tbody').on('click', 'a.edit', function (e) {
            ...
            $('[name="kt_modal_edit_form_nhanVienId"]').append("<option value=" + selectedDataRow.nhanVien.id + " selected>" + selectedDataRow.nhanVien.fullName + "</option>").trigger('change');

            modal_header_text.text("Cập nhật phát hàng");
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/LichSuPhatHang/DeleteByIds", dtTable, null)
            .then(function () {
                dtTable.draw();
                App.showHideButtonDelete(false);
            });
