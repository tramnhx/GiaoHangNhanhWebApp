...
var ThaoBaoHang = function () {
    ...
    let initialComponents = () => {
        ...
        $('[name="btnCreate"]').click(function (e) {
            ...
            window.location.href = "/ThaoBaoHang/Edit";
        });
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/ThaoBaoHang/DataTableGetList";
        ...
        $('#dtTable tbody').on('click', 'a.edit', function (e) {
            ...
            if (selectedDataRow != null) {
                window.location.href = "/ThaoBaoHang/Edit?id=" + selectedDataRow.id;
            }
        });
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/ThaoBaoHang/DeleteByIds", dtTable, null)
            .then(function () {
                dtTable.draw();
                App.showHideButtonDelete(false);
            });
