...
var KhachHang = function () {
    ...
    let validator = FormValidation.formValidation(modal_form[0], {
        fields: {
            kt_modal_edit_form_code: { validators: { notEmpty: { message: "vui lòng nhập mã khách hàng" } } },
            kt_modal_edit_form_name: { validators: { notEmpty: { message: "vui lòng nhập tên khách hàng" } } },
            kt_modal_edit_form_numberphone: { validators: { notEmpty: { message: "vui lòng nhập số điện thoại" } } },
            kt_modal_edit_form_email: { validators: { notEmpty: { message: "vui lòng nhập email" } } },
            kt_modal_edit_form_diachi: { validators: { notEmpty: { message: "vui lòng nhập địa chỉ" } } },
        },
        plugins: {
    ...
    let initialComponents = () => {
        ...
        $('[name="btnCreate"]').click(function (e) {
            ...
            editingDataRow = null;
            modal_header_text.text("Thêm một khách hàng");
                ...
                validator.validate().then(function (e) {
                    "Valid" == e ?
                        (
                            ...
                            App.sendDataToURL("/KhachHang/Save", data, "POST")
                                .then(function (res) {
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/KhachHang/DataTableGetList";
        ...
        datatableOption.columns = [
            ...
            { "data": "code", "name": "code", "autoWidth": true, "title": "Mã khách hàng" },
            { "data": "name", "name": "name", "autoWidth": true, "title": "Tên khách hàng" },
        ...
        $('#dtTable tbody').on('click', 'a.edit', function (e) {
            ...
            $('input[data-field="DiaChi"]').val(selectedDataRow.diaChi);

            modal_header_text.text("Cập nhật khách hàng");
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/KhachHang/DeleteByIds", dtTable, null)
            .then(function () {
                dtTable.draw();
                App.showHideButtonDelete(false);
            });
