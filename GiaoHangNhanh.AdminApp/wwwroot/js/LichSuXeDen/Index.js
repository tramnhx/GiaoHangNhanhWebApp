...
var LichSuXeDen = function () {
    ...
    // bắt buộc nhập thông tin khi thực hiện chức năng
    let validator = FormValidation.formValidation(modal_form[0], {
        fields: {
            kt_modal_edit_form_buuCucId: { validators: { notEmpty: { message: "vui lòng nhập trạm trước" } } },
            kt_modal_edit_form_vanDonId: { validators: { notEmpty: { message: "vui lòng nhập vận đơn" } } },
            kt_modal_edit_form_sealXe: { validators: { notEmpty: { message: "vui lòng nhập seal xe" } } },
            kt_modal_edit_form_sealBao: { validators: { notEmpty: { message: "vui lòng nhập seal bao" } } }
        },
        plugins: {
    ...
    let initialComponents = () => {
        ...
        $('[name="btnCreate"]').click(function (e) {
            ...
            editingDataRow = null;
            modal_header_text.text("Thêm xe đến");
                ...
                validator.validate().then(function (e) {
                    "Valid" == e ?
                        (
                            ...
                            App.sendDataToURL("/LichSuXeDen/Save", data, "POST")
                                .then(function (res) {
        ...
        // modal add - sử dụng filter để xổ ra trường dl mà mình chọn1
    ...
    let initialDatatable = function () {
        ...
        datatableOption.ajax.url = "/LichSuXeDen/DataTableGetList";
        ...
        datatableOption.columns = [
            ...
            {
                "data": "buuCuc", "name": "buuCuc", "autoWidth": true, "title": "Trạm trước", "render": function (data, type, full, meta) {
        ...
        $('#dtTable tbody').on('click', 'a.edit', function (e) {
            ...
            modal_header_text.text("Cập nhật xe đến");
    ...
    function deleteDataRows(dataRows) {
        App.deleteDataConfirm({ ids: dataRows.map((item) => item.id) }, "/LichSuXeDen/DeleteByIds", dtTable, null)
            .then(function () {
                dtTable.draw();
                App.showHideButtonDelete(false);
            });
