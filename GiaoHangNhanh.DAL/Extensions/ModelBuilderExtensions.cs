    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Menu>().HasData(
                ...
                new Menu() { Id = 9, SortOrder = 1, IsDeleted = false, IsActive = true, Code = "DM_DV", Name = "Dịch vụ", ParentId = 8, Link = "/DichVu/Index", ControllerName = "DanhMucDichVu", ActionName = "Index" },
                new Menu() { Id = 11, SortOrder = 3, IsDeleted = false, IsActive = true, Code = "DM_CTGH", Name = "Công ty gửi hàng", ParentId = 8, Link = "/CongTyGuiHang/Index", ControllerName = "DanhMucCongTyGuiHang", ActionName = "Index" },
                new Menu() { Id = 12, SortOrder = 4, IsDeleted = false, IsActive = true, Code = "DM_PTTT", Name = "Phương thức thanh toán", ParentId = 8, Link = "/PhuongThucThanhToan/Index", ControllerName = "DanhMucPhuongThucThanhToan", ActionName = "Index" },
